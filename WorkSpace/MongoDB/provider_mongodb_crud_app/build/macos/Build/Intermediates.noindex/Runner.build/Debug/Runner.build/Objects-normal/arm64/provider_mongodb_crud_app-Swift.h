...
#ifndef PROVIDER_MONGODB_CRUD_APP_SWIFT_H
#define PROVIDER_MONGODB_CRUD_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="provider_mongodb_crud_app",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC25provider_mongodb_crud_app11AppDelegate")
...
SWIFT_CLASS("_TtC25provider_mongodb_crud_app17MainFlutterWindow")
